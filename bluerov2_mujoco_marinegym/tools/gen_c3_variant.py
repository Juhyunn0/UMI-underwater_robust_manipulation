...
NOT in Onshape yet, so it is deliberately absent here (add it via gen_gripper_variant.py's
heavy_gripper variant once it exists in CAD). Sibling of gen_gripper_variant.py; same
...
export + mesh registration — see process_c3_mesh.py). The C3 sits front-bottom on the
...
Run in `robust`:  python gen_c3_variant.py
"""
import json
import os
import re
...
def build():
    ...
    header = (
        "<!-- GENERATED by gen_c3_variant.py from bluerov_heavy.xml - DO NOT EDIT BY HAND "
        "(rerun the script).\n"
        ...
        "     C3 pose measured from Onshape 2026-07-19 (process_c3_mesh.py). See "
    ...
    # - see gen_gripper_variant.py / KNOWN_ISSUES). Dropped Ixz = +0.046 (12.4% of Ixx) is
