...
Run (robust env only -- needs mujoco/cv2/pupil_apriltags):
    ...
    /home/bdml/miniforge3/envs/robust/bin/python tools/gen_pool_apriltags.py --selftest
    /home/bdml/miniforge3/envs/robust/bin/python tools/gen_pool_apriltags.py            # full build
...
def build_fragment_xml(cfg, tags, args, half_edge):
  ...
  <!-- GENERATED by tools/gen_pool_apriltags.py -- do not edit by hand. VISUAL ONLY.
...
def build_tag_plane_fragment(cfg, args, n_blocks, floor_extent):
    ...
    water_alpha = float(getattr(args, "water_alpha", 0.18))
    return f"""<mujocoinclude>
  <!-- GENERATED by tools/gen_pool_apriltags.py (--tag-mode plane) -- do not edit by hand. VISUAL ONLY.
...
WRAPPER_TMPL = """<mujoco model="{model}">
  <!-- GENERATED by tools/gen_pool_apriltags.py. Opt-in pool scene = ROV + AprilTag floor.
